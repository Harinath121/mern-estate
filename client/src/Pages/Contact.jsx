    ...
    <>
        {landlord && (
            <div className="flex flex-col gap-4">
                ...
                <Link to={`mailto:${landlord.email}?subject=Regarding ${listing.name} &body=${message}`} className='bg-slate-700 text-white rounded-lg p-2 text-center uppercase hover:opacity-95'>
                    Send message
                </Link>
            </div>
        )}
